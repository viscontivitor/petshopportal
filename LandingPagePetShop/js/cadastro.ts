...
var senha = document.getElementById("senha") as HTMLDivElement  | null;
...
const myInput = document.getElementById('senha') as HTMLDivElement;
myInput.onfocus = function () {
  const caixamsg = document.getElementById("caixamsg") as HTMLDivElement ;
